...
public class RadarChart extends PieRadarChartBase<RadarData> {
	...
	/**
	 * modulus that determines how many labels and web-lines are skipped before
	 * the next is drawn
	 */
	...
	protected void calcMinMax() {
		...
		mYAxis.calculate(mData.getYMin(AxisDependency.LEFT),
	...
	/**
	 * Sets the number of web-lines that should be skipped on chart web before
	 * the next one is drawn. This targets the lines that come from the center
	 * of the RadarChart.
	 *
	 * @param count
