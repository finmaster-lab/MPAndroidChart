...
public class CombinedData extends
	...
	public void calcMinMax() {
		...
		for (ChartData data : allData) {
			...
			List<IBarLineScatterCandleBubbleDataSet<? extends Entry>> sets = data
					.getDataSets();
	...
	public IBarLineScatterCandleBubbleDataSet<? extends Entry> getDataSetByHighlight(
		...
		if (highlight.getDataSetIndex()<0||highlight.getDataSetIndex() >= data.getDataSetCount())
			return null;

		return (IBarLineScatterCandleBubbleDataSet<? extends Entry>) data
				.getDataSets().get(highlight.getDataSetIndex());
	}
	...
	public boolean removeDataSet(
			IBarLineScatterCandleBubbleDataSet<? extends Entry> d) {
