...
public abstract class PieRadarHighlighter<T extends PieRadarChartBase>
	...
	/**
	 * Returns the closest Highlight object of the given objects based on the
	 * touch position inside the chart.
	 *
	 * @param index
	 * @param x
	 * @param y
	 * @return
	 */
	protected abstract Highlight getClosestHighlight(int index, float x,
			float y);
}
