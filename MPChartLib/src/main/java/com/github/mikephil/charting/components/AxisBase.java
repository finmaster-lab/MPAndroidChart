...
public abstract class AxisBase extends ComponentBase {
	...
	/**
	 * When true, axis labels are controlled by the `granularity` property. When
	 * false, axis values could possibly be repeated. This could happen if two
	 * adjacent axis values are rounded to same value. If using granularity this
	 * could be avoided by having fewer axis values visible.
	 */
	...
	/**
	 * Extra spacing for `axisMinimum` to be added to automatically calculated
	 * `axisMinimum`
	 */
	protected float mSpaceMin = 0.f;
	/**
	 * Extra spacing for `axisMaximum` to be added to automatically calculated
	 * `axisMaximum`
	 */
	...
	/**
	 * Centers the axis labels instead of drawing them at their original
	 * position. This is useful especially for grouped BarChart.
	 *
	 * @param enabled
	 */
	 ...
	 *
	 * @param count
	 *            the number of y-axis labels that should be displayed
	 * @param force
	...
	/**
	 * Sets the number of label entries for the y-axis max = 25, min = 2,
	 * default: 6, be aware that this number is not fixed.
	 *
	 * @param count
	 *            the number of y-axis labels that should be displayed
	 */
	...
	public void setGranularity(float granularity) {
		...
		// set this to true if it was disabled, as it makes no sense to call
		// this method with granularity disabled
	...
	/**
	 * If this is set to false, the grid lines are draw on top of the actual
	 * data, otherwise behind. Default: true
	 *
	 * @param enabled
	 */
	...
	public ValueFormatter getValueFormatter() {
		...
		if (mAxisValueFormatter == null
				|| (mAxisValueFormatter instanceof DefaultAxisValueFormatter
						&& ((DefaultAxisValueFormatter) mAxisValueFormatter)
								.getDecimalDigits() != mDecimals))
	 ...
	 * - -". THIS ONLY WORKS IF HARDWARE-ACCELERATION IS TURNED OFF. Keep in
	 * mind that hardware acceleration boosts performance.
	 *
	 * @param lineLength
	...
	public void enableGridDashedLine(float lineLength, float spaceLength,
			float phase) {
		mGridDashPathEffect = new DashPathEffect(
	 ...
	 *            offset, in degrees (normally, use 0)
	 */
	public void enableAxisLineDashedLine(float lineLength, float spaceLength,
			float phase) {
		mAxisLineDashPathEffect = new DashPathEffect(
				new float[] { lineLength, spaceLength }, phase);
	}
	...
	/**
	 * Returns true if the axis max value has been customized (and is not
	...
	/**
	 * Returns true if the axis min value has been customized (and is not
	 * calculated automatically)
	 *
	 * @return
	 */
	...
	/**
	 * Calculates the minimum / maximum and range values of the axis with the
	 * given minimum and maximum values from the chart data.
	 *
	 * @param dataMin
	...
	/**
	 * Gets extra spacing for `axisMinimum` to be added to automatically
	 * calculated `axisMinimum`
	 */
	...
	/**
	 * Sets extra spacing for `axisMinimum` to be added to automatically
	 * calculated `axisMinimum`
	 */
	...
	/**
	 * Gets extra spacing for `axisMaximum` to be added to automatically
	 * calculated `axisMaximum`
	 */
	...
	/**
	 * Sets extra spacing for `axisMaximum` to be added to automatically
	 * calculated `axisMaximum`
	 */
