...
public class XAxisRendererRadarChart extends XAxisRenderer {
	...
	public XAxisRendererRadarChart(ViewPortHandler viewPortHandler, XAxis xAxis,
			RadarChart chart) {
	...
	public void renderAxisLabels(Canvas c) {
		...
		for (int i = 0; i < mChart.getData().getMaxEntryCountSet()
				.getEntryCount(); i++) {
			...
			drawLabel(c, label, pOut.x,
					pOut.y - mXAxis.mLabelRotatedHeight / 2.f, drawLabelAnchor,
