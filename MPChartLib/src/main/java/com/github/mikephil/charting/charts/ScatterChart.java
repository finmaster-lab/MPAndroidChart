...
public class ScatterChart extends BarLineChartBase<ScatterData>
	...
	/**
	 * Predefined ScatterShapes that allow the specification of a shape a
	 * ScatterDataSet should be drawn with. If a ScatterShape is specified for a
	 * ScatterDataSet, the required renderer is set.
	 */
	public enum ScatterShape {

		SQUARE("SQUARE"), CIRCLE("CIRCLE"), TRIANGLE("TRIANGLE"), CROSS(
				"CROSS"), X("X"), CHEVRON_UP(
						"CHEVRON_UP"), CHEVRON_DOWN("CHEVRON_DOWN");
		...
		public static ScatterShape[] getAllDefaultShapes() {
			return new ScatterShape[] { SQUARE, CIRCLE, TRIANGLE, CROSS, X,
