...
public class Highlight {
	 ...
	 */
	public Highlight(float x, float y, float xPx, float yPx, int dataSetIndex,
			int stackIndex, YAxis.AxisDependency axis) {
	...
	/**
	 * Returns the x-position in pixels where this highlight object was last
	 * drawn.
	 *
	 * @return
	 */
	...
	/**
	 * Returns the y-position in pixels where this highlight object was last
	 * drawn.
	 *
	 * @return
	 */
	...
	public String toString() {
		return "Highlight, x: " + mX + ", y: " + mY + ", dataSetIndex: "
