...
public interface ILineDataSet extends ILineRadarDataSet<Entry> {
	...
	/**
	 * Returns the intensity of the cubic lines (the effect intensity). Max = 1f
	 * = very cubic, Min = 0.05f = low cubic effect, Default: 0.2f
	 *
	 * @return
	 */
	...
	/**
	 * Returns true if the dashed-line effect is enabled, false if not. If the
	 * DashPathEffect object is null, also return false here.
	 *
	 * @return
	 */
