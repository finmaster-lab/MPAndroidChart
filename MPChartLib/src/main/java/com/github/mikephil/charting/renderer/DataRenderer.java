...
public abstract class DataRenderer extends Renderer {
	...
	public DataRenderer(ChartAnimator animator,
	...
	/**
	 * Draws the actual data in form of lines, bars, ... depending on Renderer
	 * subclass.
	 *
	 * @param c
	 */
	 ...
	 * @param color
	 */
	public abstract void drawValue(Canvas c, String valueText, float x, float y,
			int color);
	...
	/**
	 * Draws all highlight indicators for the values that are currently
	 * highlighted.
	 *
	 * @param c
	 * @param indices
