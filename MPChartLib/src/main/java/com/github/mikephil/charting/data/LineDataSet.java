...
public class LineDataSet extends LineRadarDataSet<Entry>
	...
	/**
	 * Sets the hole radius of the drawn circles. Default radius = 2f, Min =
	 * 0.5f
	 *
	 * @param holeRadius
	 */
	...
	/**
	 * This function is deprecated because of unclarity. Use getCircleRadius
	 * instead.
	 */
	@Deprecated
	 ...
	 * size = 4f
	 * <p/>
	 * This method is deprecated because of unclarity. Use setCircleRadius
	 * instead.
	 *
	 * @param size
	 */
	 ...
	 * -". THIS ONLY WORKS IF HARDWARE-ACCELERATION IS TURNED OFF. Keep in mind
	 * that hardware acceleration boosts performance.
	 *
	 * @param lineLength
	 ...
	 * Colors are reused as soon as the number of Entries the DataSet represents
	 * is higher than the size of the colors array. You can use "new String[] {
	 * R.color.red, R.color.green, ... }" to provide colors for this method.
	...
	/**
	 * Sets a custom IFillFormatter to the chart that handles the position of
	 * the filled-line for each DataSet. Set this to null to use the default
	 * logic.
	 *
	 * @param formatter
	 */
