...
public abstract class LineRadarRenderer extends LineScatterCandleRadarRenderer {
	...
	public LineRadarRenderer(ChartAnimator animator,
	 ...
	 * @param drawable
	 */
	protected void drawFilledPath(Canvas c, Path filledPath,
			Drawable drawable) {
	 ...
	 * @param fillAlpha
	 */
	protected void drawFilledPath(Canvas c, Path filledPath, int fillColor,
			int fillAlpha) {
	...
	/**
	 * Clip path with hardware acceleration only working properly on API level
	 * 18 and above.
	 *
	 * @return
	 */
