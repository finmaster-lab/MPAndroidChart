...
public abstract class LineScatterCandleRadarDataSet<T extends Entry>
	...
	/**
	 * Enables / disables the horizontal highlight-indicator. If disabled, the
	...
	/**
	 * Enables / disables the vertical highlight-indicator. If disabled, the
	 * indicator is not drawn.
	 * 
	 * @param enabled
	 */
	 ...
	 */
	public void enableDashedHighlightLine(float lineLength, float spaceLength,
			float phase) {
		mHighlightDashPathEffect = new DashPathEffect(
	...
	/**
	 * Returns true if the dashed-line effect is enabled for highlight lines,
	 * false if not. Default: disabled
	 *
	 * @return
	 */
	...
	protected void copy(
			LineScatterCandleRadarDataSet lineScatterCandleRadarDataSet) {
