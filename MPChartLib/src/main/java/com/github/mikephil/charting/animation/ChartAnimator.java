...
/**
 * Object responsible for all animations in the Chart. Animations require API
 * level 11.
 *
...
public class ChartAnimator {
	...
	public void animateXY(int durationMillisX, int durationMillisY) {
		animateXY(durationMillisX, durationMillisY, Easing.Linear,
				Easing.Linear);
	}
