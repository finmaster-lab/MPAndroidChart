...
public class LegendEntry {
	 ...
	 *
	 * `NONE` will avoid drawing a form, and any related space. `EMPTY` will
	 * avoid drawing a form, but keep its space. `DEFAULT` will use the Legend's
	 * default.
	 */
	 ...
	 * @param formLineWidth
	 *            Set to NaN to use the legend's default.
	 * @param formLineDashEffect
	 *            Set to nil to use the legend's default.
	 * @param formColor
	 *            The color for drawing the form.
	 */
	public LegendEntry(String label, Legend.LegendForm form, float formSize,
			float formLineWidth, DashPathEffect formLineDashEffect,
			int formColor) {
		this.label = label;
		this.form = form;
