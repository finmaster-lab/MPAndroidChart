...
public class HorizontalBarChart extends BarChart {
	...
	public void calculateOffsets() {
		...
		if (mAxisLeft.needsOffset()) {
			offsetTop += mAxisLeft.getRequiredHeightSpace(
					mAxisRendererLeft.getPaintAxisLabels());
		}

		if (mAxisRight.needsOffset()) {
			offsetBottom += mAxisRight.getRequiredHeightSpace(
					mAxisRendererRight.getPaintAxisLabels());
		}
		...
		if (mLogEnabled) {
			...
			Log.i(LOG_TAG,
					"Content: " + mViewPortHandler.getContentRect().toString());
		}
