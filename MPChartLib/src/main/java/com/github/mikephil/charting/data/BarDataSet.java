...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<BarEntry>
	...
	/**
	 * Sets the start and end color for gradient color, ONLY color that should
	...
	/**
	 * Returns the width used for drawing borders around the bars. If
	 * borderWidth == 0, no border will be drawn.
	 *
	 * @return
	 */
	@Override
	...
	/**
	 * Sets the width used for drawing borders around the bars. If borderWidth
