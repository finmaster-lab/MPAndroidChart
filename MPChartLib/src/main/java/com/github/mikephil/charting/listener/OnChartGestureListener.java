...
public interface OnChartGestureListener {
	...
	/**
	 * Callbacks when a touch-gesture has ended on the chart (ACTION_UP,
	 * ACTION_CANCEL)
	 *
	 * @param me
	 * @param lastPerformedGesture
	 ...
	 * @param velocityY
	 */
	void onChartFling(MotionEvent me1, MotionEvent me2, float velocityX,
			float velocityY);

	/**
	 * Callbacks when the chart is scaled / zoomed via pinch zoom / double-tap
	 * gesture.
	 *
	 * @param me
	 * @param scaleX
