...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
	...
	/**
	 * Calc minimum and maximum y-values over all DataSets. Tell DataSets to
	 * recalculate their min and max y-values, this is only needed for
	 * autoScaleMinMax.
	 *
	 * @param fromX
	...
	/**
	 * Adjusts the current minimum and maximum values based on the provided
	 * Entry object.
	 *
	 * @param e
	 * @param axis
	...
	/**
	 * Removes the Entry object closest to the given DataSet at the specified
	 * index. Returns true if an Entry was removed, false if no Entry was found
	...
	/**
	 * Returns the index of the provided DataSet in the DataSet array of this
	 * data object, or -1 if it does not exist.
	 *
	 * @param dataSet
	 * @return
	 */
	...
	/**
	 * Returns the first DataSet from the datasets-array that has it's
	 * dependency on the left axis. Returns null if no DataSet with left
	 * dependency could be found.
	 *
	 * @return
	 */
	...
	/**
	 * Returns the first DataSet from the datasets-array that has it's
	 * dependency on the right axis. Returns null if no DataSet with right
	 * dependency could be found.
	 *
	 * @return
	 */
	...
	/**
	 * Sets the same list of value-colors for all DataSets this data object
	 * contains.
	 *
	 * @param colors
	 */
	 ...
	 * contains. If set to true, this means that values can be highlighted
	...
	/**
	 * Returns the total entry count across all DataSet objects this data object
	 * contains.
	 *
	 * @return
	 */
	...
	/**
	 * Returns the DataSet object with the maximum number of entries or null if
